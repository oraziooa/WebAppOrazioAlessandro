...
namespace WebAppOrazioAlessandro.Controllers
{
    ...
    public class CategorieMerceologicheController : ControllerBase
    {
        private readonly ICategoriaMerceologicaService _service;

        public CategorieMerceologicheController(ICategoriaMerceologicaService service)
        {
            _service = service;
        }
        ...
        {
            BackgroundJob.Enqueue<CategoriaMerceologicaDeletionService>(
